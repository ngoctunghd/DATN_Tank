	...
	public override void OnInspectorGUI(){
		...
		if (t.showPSInspector){
			ETCGuiTools.BeginGroup();{
                ...
                //// Type
                //t.joystickType = (ETCButton.JoystickType)EditorGUILayout.EnumPopup("Type", t.joystickType);

                //if (t.joystickType == ETCButton.JoystickType.Static)
                //{
                //    t.anchor = (ETCBase.RectAnchor)EditorGUILayout.EnumPopup("Anchor", t.anchor);
                //    if (t.anchor != ETCBase.RectAnchor.UserDefined)
                //    {
                ...
                //}
                //else if (t.joystickType == ETCButton.JoystickType.Dynamic)
                //{
                ...
                //    t.joystickArea = (ETCButton.JoystickArea)EditorGUILayout.EnumPopup("Joystick area", t.joystickArea);
                //    if (t.joystickArea == ETCButton.JoystickArea.UserDefined)
                //    {
