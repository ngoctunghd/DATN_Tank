...
public class OnlineModeMenu : MonoBehaviour {
	...
	public static readonly string SceneNameMenu = "OnlineModeMenu";
	
	public static readonly string SceneNameGame = "OnlineModePlay";
